...
## 2026-08-26 (Routine, autonom) — Leerlauf: nichts zu tun (83. in Folge)

**Verifiziert (Python, unabhängig nachgerechnet):** Wunschliste (`stand` 2026-08-20, 2 Einträge) beide erfüllt — `agastache-mexicana` → `mexikanische-duftnessel.json` (id-Treffer), `cherry-laurel`/*Prunus laurocerasus* → `kirschlorbeer.json` (id `prunus-laurocerasus`, Synonyme *Laurocerasus/Cerasus/Padus laurocerasus* + `not_for_use=true` geprüft; `cherry-laurel`-Slug = bekannte Wunschlisten-Datenqualitätsfrage, Pflanze abgedeckt). Kandidaten `Counter` = `{'entwurf_fertig': 87}`, **0× `offen`**, kein `offen`-Kandidat mit bereits existierender Datei → keine Selbstheilung nötig. `fertig/` = 118 Monographien. → 0 offene Arten aus beiden Quellen. Kein Bau, keine Statusänderung, `docs/changelog.json` unverändert. Sauber beendet — kein Fehler.
**Benachrichtigung:** bewusst keine (Lage unverändert seit 2026-08-04 — Push wäre Rauschen; Idle-Push lief bereits 2026-08-09).
**Für den Arzt:** Unverändert seit ~3 Wochen (83 Leerläufe in Folge). Nachschub kommt nur durch Menschen: neue Wunschlisten-/`offen`-Einträge — oder die 87 Entwürfe sichten/auf `geprueft` setzen. **Empfehlung unverändert: Routine strecken/pausieren, bis Nachschub vorliegt.**

## 2026-08-26 (Routine, autonom, 2. Lauf) — Leerlauf: nichts zu tun (84. in Folge)

**Verifiziert (Python):** Wunschliste `docs/wunschliste.json` (`stand` 2026-08-20, 2 Einträge) beide erfüllt — `agastache-mexicana` → `fertig/monographie-mexikanische-duftnessel.json` (id-Treffer, „Mexican giant hyssop" in `common_names_de`), `cherry-laurel`/*Prunus laurocerasus* → `fertig/monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, Synonyme *Laurocerasus/Cerasus/Padus laurocerasus* geprüft). Kandidaten `Counter` = `{'entwurf_fertig': 87}`, **0× `offen`** → keine Selbstheilung nötig. → 0 offene Arten aus beiden Quellen. Kein Bau, keine Statusänderung, `docs/changelog.json` unverändert. Sauber beendet — kein Fehler.
**Benachrichtigung:** bewusst keine (Lage unverändert seit 2026-08-04 — Push wäre Rauschen; Idle-Push lief bereits 2026-08-09).
**Für den Arzt:** Unverändert seit ~3 Wochen (84 Leerläufe in Folge). Nachschub kommt nur durch Menschen: neue Wunschlisten-/`offen`-Einträge — oder die 87 Entwürfe sichten/auf `geprueft` setzen. **Empfehlung unverändert: Routine strecken/pausieren, bis Nachschub vorliegt** (Log wächst sonst nur durch identische Leerlauf-Einträge).

## 2026-08-26 (Routine, autonom, 3. Lauf) — Leerlauf: nichts zu tun (85. in Folge)

**Verifiziert (Python):** Wunschliste (`stand` 2026-08-20, 2 Einträge) beide erfüllt — `agastache-mexicana` → `mexikanische-duftnessel.json` (id-Treffer), `cherry-laurel`/*Prunus laurocerasus* → `kirschlorbeer.json` (id `prunus-laurocerasus`, `not_for_use`-Warneintrag). Kandidaten `Counter` = `{'entwurf_fertig': 87}`, **0× `offen`** → keine Selbstheilung nötig. → 0 offene Arten aus beiden Quellen. Kein Bau, keine Statusänderung, `docs/changelog.json` unverändert. Sauber beendet — kein Fehler.
**Benachrichtigung:** bewusst keine (Lage unverändert seit 2026-08-04 — Push wäre Rauschen; Idle-Push lief bereits 2026-08-09).
**Für den Arzt:** Unverändert seit ~3 Wochen (85 Leerläufe in Folge). Nachschub kommt nur durch Menschen: neue Wunschlisten-/`offen`-Einträge — oder die 87 Entwürfe sichten/auf `geprueft` setzen. **Empfehlung unverändert: Routine strecken/pausieren, bis Nachschub vorliegt.**

## 2026-08-26 (Routine, autonom, 4. Lauf) — Leerlauf: nichts zu tun (86. in Folge)

**Verifiziert (Python):** Wunschliste (`stand` 2026-08-20, 2 Einträge) beide erfüllt — `agastache-mexicana` → `mexikanische-duftnessel.json` (id-Treffer), `cherry-laurel`/*Prunus laurocerasus* → `kirschlorbeer.json` (id `prunus-laurocerasus`, `not_for_use`-Warneintrag). Kandidaten `Counter` = `{'entwurf_fertig': 87}`, **0× `offen`** → keine Selbstheilung nötig. `fertig/` = 118 Monographien. → 0 offene Arten aus beiden Quellen. Kein Bau, keine Statusänderung, `docs/changelog.json` unverändert. Sauber beendet — kein Fehler.
**Benachrichtigung:** bewusst keine (Lage unverändert seit 2026-08-04 — Push wäre Rauschen; Idle-Push lief bereits 2026-08-09).
**Für den Arzt:** Unverändert seit ~3 Wochen (86 Leerläufe in Folge). Nachschub kommt nur durch Menschen: neue Wunschlisten-/`offen`-Einträge — oder die 87 Entwürfe sichten/auf `geprueft` setzen. **Empfehlung unverändert: Routine strecken/pausieren, bis Nachschub vorliegt** (Log wächst sonst nur durch identische Leerlauf-Einträge).

## 2026-08-27 (Routine, autonom) — Leerlauf: nichts zu tun (87. in Folge)

**Verifiziert (Python, unabhängig nachgerechnet):** Wunschliste `docs/wunschliste.json` (`stand` 2026-08-20, 2 Einträge) beide erfüllt — `agastache-mexicana` → `fertig/monographie-mexikanische-duftnessel.json` (id-Treffer), `cherry-laurel`/*Prunus laurocerasus* → `fertig/monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, `not_for_use`-Warneintrag; `cherry-laurel`-Slug = bekannte Wunschlisten-Datenqualitätsfrage, Pflanze abgedeckt). Kandidaten `Counter` = `{'entwurf_fertig': 87}`, **0× `offen`**, kein `offen`-Kandidat mit bereits existierender Datei → keine Selbstheilung nötig. `fertig/` = 118 Monographien. → 0 offene Arten aus beiden Quellen. Kein Bau, keine Statusänderung, `docs/changelog.json` unverändert. Sauber beendet — kein Fehler.
**Benachrichtigung:** bewusst keine (Lage unverändert seit 2026-08-04 — Push wäre Rauschen; Idle-Push lief bereits 2026-08-09).
**Für den Arzt:** Unverändert seit ~3 Wochen (87 Leerläufe in Folge). Nachschub kommt nur durch Menschen: neue Wunschlisten-/`offen`-Einträge — oder die 87 Entwürfe sichten/auf `geprueft` setzen. **Empfehlung unverändert: Routine strecken/pausieren, bis Nachschub vorliegt** (Log wächst sonst nur durch identische Leerlauf-Einträge).

## 2026-08-27 (Routine, autonom, 2. Lauf) — Leerlauf: nichts zu tun (88. in Folge)

**Verifiziert (Python):** Wunschliste `docs/wunschliste.json` (`stand` 2026-08-20, 2 Einträge) beide erfüllt — `agastache-mexicana` → `fertig/monographie-mexikanische-duftnessel.json` (id-Treffer), `cherry-laurel`/*Prunus laurocerasus* → `fertig/monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, `not_for_use`-Warneintrag). Kandidaten `Counter` = `{'entwurf_fertig': 87}`, **0× `offen`** → keine Selbstheilung nötig. → 0 offene Arten aus beiden Quellen. Kein Bau, keine Statusänderung, `docs/changelog.json` unverändert. Sauber beendet — kein Fehler.
**Benachrichtigung:** bewusst keine (Lage unverändert seit 2026-08-04 — Push wäre Rauschen).
**Für den Arzt:** Unverändert seit ~3 Wochen (88 Leerläufe in Folge). Nachschub kommt nur durch Menschen: neue Wunschlisten-/`offen`-Einträge — oder die 87 Entwürfe sichten/auf `geprueft` setzen. **Empfehlung unverändert: Routine strecken/pausieren, bis Nachschub vorliegt** (Log wächst sonst nur durch identische Leerlauf-Einträge).

## 2026-08-27 (Routine, autonom, 3. Lauf) — Leerlauf: nichts zu tun (89. in Folge)

**Verifiziert (Python):** Wunschliste `docs/wunschliste.json` (`stand` 2026-08-20, 2 Einträge) beide erfüllt — `agastache-mexicana` → `fertig/monographie-mexikanische-duftnessel.json` (id-Treffer), `cherry-laurel`/*Prunus laurocerasus* → `fertig/monographie-kirschlorbeer.json` (id `prunus-laurocerasus`). Kandidaten `Counter` = `{'entwurf_fertig': 87}`, **0× `offen`**, alle `datei`-Pfade vorhanden → keine Selbstheilung nötig. → 0 offene Arten aus beiden Quellen. Kein Bau, keine Statusänderung, `docs/changelog.json` unverändert. Sauber beendet — kein Fehler.
**Benachrichtigung:** bewusst keine (Lage unverändert seit 2026-08-04 — Push wäre Rauschen).
**Für den Arzt:** Unverändert seit ~3 Wochen (89 Leerläufe in Folge). Nachschub kommt nur durch Menschen: neue Wunschlisten-/`offen`-Einträge — oder die 87 Entwürfe sichten/auf `geprueft` setzen. **Empfehlung unverändert: Routine strecken/pausieren, bis Nachschub vorliegt** (Log wächst sonst nur durch identische Leerlauf-Einträge).

## 2026-08-27 (Routine, autonom, 4. Lauf) — Leerlauf: nichts zu tun (90. in Folge)

**Verifiziert (Python):** Wunschliste `docs/wunschliste.json` (`stand` 2026-08-20, 2 Einträge) beide erfüllt — `agastache-mexicana` → `fertig/monographie-mexikanische-duftnessel.json` (id-Treffer), `cherry-laurel`/*Prunus laurocerasus* → `fertig/monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, `not_for_use`-Warneintrag). Kandidaten `Counter` = `{'entwurf_fertig': 87}`, **0× `offen`** → keine Selbstheilung nötig. → 0 offene Arten aus beiden Quellen. Kein Bau, keine Statusänderung, `docs/changelog.json` unverändert. Sauber beendet — kein Fehler.
**Benachrichtigung:** bewusst keine (Lage unverändert seit 2026-08-04 — Push wäre Rauschen).
**Für den Arzt:** Unverändert (90 Leerläufe in Folge). Nachschub kommt nur durch Menschen: neue Wunschlisten-/`offen`-Einträge — oder die 87 Entwürfe sichten/auf `geprueft` setzen. **Empfehlung unverändert: Routine strecken/pausieren, bis Nachschub vorliegt** (Log wächst sonst nur durch identische Leerlauf-Einträge).

## 2026-08-28 (Routine, autonom) — Leerlauf: nichts zu tun (91. in Folge)
...
## 2026-08-29T (Routine, autonom) — Leerlauf (93. in Folge), Kurzeintrag

Unverändert: Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Einträge) beide in `fertig/` erledigt (`agastache-mexicana`→`mexikanische-duftnessel.json` id-Treffer; `cherry-laurel`/*Prunus laurocerasus*→`kirschlorbeer.json`, id `prunus-laurocerasus`). Kandidaten (Python `Counter`) = `{'entwurf_fertig': 87}`, **0× offen**, alle `datei`-Pfade vorhanden → keine Selbstheilung. `fertig/` = 118 Monographien. Kein Bau, kein Statuswechsel, `docs/changelog.json` unverändert. Bewusst nur eine Zeile (Log wächst sonst nur durch identische Leerlauf-Blöcke — bereits ~460 KB). Keine Benachrichtigung (Lage unverändert seit 2026-08-04, kein Fehler). **Empfehlung unverändert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Einträge liefert oder die 87 Entwürfe gesichtet (auf `geprueft` gesetzt) werden.**

## 2026-08-29T (Routine, autonom, 2. Lauf) — Leerlauf (94. in Folge), Kurzeintrag

Unverändert: Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Einträge) beide in `fertig/` erledigt (`agastache-mexicana`→`mexikanische-duftnessel.json` id-Treffer; `cherry-laurel`/*Prunus laurocerasus*→`kirschlorbeer.json`, id `prunus-laurocerasus`, Synonyme *Laurocerasus/Cerasus/Padus laurocerasus* geprüft). Kandidaten (Python `Counter`) = `{'entwurf_fertig': 87}`, **0× offen** → keine Selbstheilung. Kein Bau, kein Statuswechsel, `docs/changelog.json` unverändert. Bewusst nur eine Zeile (Log wächst sonst nur durch identische Leerlauf-Blöcke — bereits ~460 KB). Keine Benachrichtigung (Lage unverändert seit 2026-08-04, kein Fehler). **Empfehlung unverändert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Einträge liefert oder die 87 Entwürfe gesichtet (auf `geprueft` gesetzt) werden.**

## 2026-08-29T (Routine, autonom, 3. Lauf) — Leerlauf (95. in Folge), Kurzeintrag

Unverändert: Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Einträge) beide in `fertig/` erledigt (`agastache-mexicana`→`mexikanische-duftnessel.json` id-Treffer; `cherry-laurel`/*Prunus laurocerasus*→`kirschlorbeer.json`, id `prunus-laurocerasus`). Kandidaten (Python `Counter`) = `{'entwurf_fertig': 87}`, **0× offen** → keine Selbstheilung. `fertig/` = 118 Monographien. Kein Bau, kein Statuswechsel, `docs/changelog.json` unverändert. Bewusst nur eine Zeile. Keine Benachrichtigung (Lage unverändert seit 2026-08-04, kein Fehler). **Empfehlung unverändert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Einträge liefert oder die 87 Entwürfe gesichtet (auf `geprueft` gesetzt) werden.**

## 2026-08-30T (Routine, autonom) — Leerlauf (96. in Folge), Kurzeintrag

Unverändert: Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Einträge) beide in `fertig/` erledigt (`agastache-mexicana`→`mexikanische-duftnessel.json` id-Treffer; `cherry-laurel`/*Prunus laurocerasus*→`kirschlorbeer.json`, id `prunus-laurocerasus`). Kandidaten (Python `Counter`) = `{'entwurf_fertig': 87}`, **0× offen**, alle `datei`-Pfade vorhanden → keine Selbstheilung. `fertig/` = 118 Monographien. Kein Bau, kein Statuswechsel, `docs/changelog.json` unverändert. Bewusst nur eine Zeile (Log wächst sonst nur durch identische Leerlauf-Blöcke). Keine Benachrichtigung (Lage unverändert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unverändert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Einträge liefert oder die 87 Entwürfe gesichtet (auf `geprueft` gesetzt) werden.**

## 2026-08-30T (Routine, autonom, 2. Lauf) — Leerlauf (97. in Folge), Kurzeintrag

Unverändert: Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Einträge) beide in `fertig/` erledigt (`agastache-mexicana`→`mexikanische-duftnessel.json` id-Treffer; `cherry-laurel`/*Prunus laurocerasus*→`kirschlorbeer.json`, id `prunus-laurocerasus`). Kandidaten (Python `Counter`) = `{'entwurf_fertig': 87}`, **0× offen**, alle `datei`-Pfade vorhanden → keine Selbstheilung. `fertig/` = 118 Monographien. Kein Bau, kein Statuswechsel, `docs/changelog.json` unverändert. Bewusst nur eine Zeile (Log wächst sonst nur durch identische Leerlauf-Blöcke). Keine Benachrichtigung (Lage unverändert seit 2026-08-04, kein Fehler). **Empfehlung unverändert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Einträge liefert oder die 87 Entwürfe gesichtet (auf `geprueft` gesetzt) werden.**

## 2026-08-30T (Routine, autonom, 3. Lauf) — Leerlauf (98. in Folge), Kurzeintrag

Unverändert: Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Einträge) beide in `fertig/` erledigt (`agastache-mexicana`→`mexikanische-duftnessel.json` id-Treffer; `cherry-laurel`/*Prunus laurocerasus*→`kirschlorbeer.json`, id `prunus-laurocerasus`). Kandidaten (grep über `kraeuter-kandidaten.json`) = `{'entwurf_fertig': 87}`, **0× offen**, alle `datei`-Pfade vorhanden → keine Selbstheilung. `fertig/` = 118 Monographien. Kein Bau, kein Statuswechsel, `docs/changelog.json` unverändert. Bewusst nur eine Zeile. Keine Benachrichtigung (Lage unverändert seit 2026-08-04, kein Fehler). **Empfehlung unverändert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Einträge liefert oder die 87 Entwürfe gesichtet (auf `geprueft` gesetzt) werden.**

## 2026-08-30T (Routine, autonom, 4. Lauf) — Leerlauf (99. in Folge), Kurzeintrag

Unverändert: Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Einträge) beide in `fertig/` erledigt — selbst verifiziert: `agastache-mexicana`→`mexikanische-duftnessel.json` (id-Treffer, scientific_name *Agastache mexicana*); `cherry-laurel`/*Prunus laurocerasus*→`kirschlorbeer.json` (id `prunus-laurocerasus`, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprüft). Kandidaten (Python `Counter`) = `{'entwurf_fertig': 87}`, **0× offen** → keine Selbstheilung. `fertig/` = 118 Monographien. Kein Bau, kein Statuswechsel, `docs/changelog.json` unverändert. Bewusst nur eine Zeile. Keine neue Benachrichtigung (Lage unverändert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unverändert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Einträge liefert oder die 87 Entwürfe gesichtet (auf `geprueft` gesetzt) werden.**

## 2026-08-31T (Routine, autonom) — Leerlauf (100. in Folge), Kurzeintrag

Selbst verifiziert (nicht nur aus dem Log): Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Einträge) beide in `fertig/` erledigt — `agastache-mexicana` (id-Treffer, `mexikanische-duftnessel.json`); `cherry-laurel`/*Prunus laurocerasus* → `kirschlorbeer.json` (id `prunus-laurocerasus`). Kandidaten (Python `Counter`) = `{'entwurf_fertig': 87}`, **0× offen** → kein Bau, keine Selbstheilung. Kein Statuswechsel, `docs/changelog.json` unverändert. Bewusst nur eine Zeile (identische Leerlauf-Blöcke). Keine Benachrichtigung (Lage unverändert seit 2026-08-04, kein Fehler). **Empfehlung unverändert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Einträge liefert oder die 87 Entwürfe ärztlich gesichtet (auf `geprueft`) werden.**

## 2026-08-31T06:46Z (Routine, autonom) — Leerlauf (101. in Folge), Kurzeintrag

Selbst verifiziert: Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Einträge) beide in `fertig/` erledigt — `agastache-mexicana` (id-Treffer, `mexikanische-duftnessel.json`); `cherry-laurel`/*Prunus laurocerasus* → `kirschlorbeer.json` (id `prunus-laurocerasus`, Synonyme geprüft). Kandidaten (Python `Counter`) = `{'entwurf_fertig': 87}`, **0× offen**, alle `datei`-Pfade vorhanden → kein Bau, keine Selbstheilung. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unverändert. Bewusst nur eine Zeile. Keine Benachrichtigung (Lage unverändert seit 2026-08-04, Idle-Push lief 2026-08-09, kein Fehler). **Empfehlung unverändert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Einträge liefert oder die 87 Entwürfe ärztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-01T (Routine, autonom) — Leerlauf (102. in Folge), Kurzeintrag

Selbst verifiziert (Python, nicht nur aus dem Log): Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Einträge) beide in `fertig/` erledigt — `agastache-mexicana` → `mexikanische-duftnessel.json` (id-Treffer, scientific_name *Agastache mexicana*); `cherry-laurel`/*Prunus laurocerasus* → `kirschlorbeer.json` (id `prunus-laurocerasus`, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprüft). Kandidaten (`Counter`) = `{'entwurf_fertig': 87}`, **0× offen**, alle `datei`-Pfade vorhanden → kein Bau, keine Selbstheilung. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unverändert. Bewusst nur eine Zeile (Log wächst sonst nur durch identische Leerlauf-Blöcke, ~460 KB). Keine Benachrichtigung (Lage unverändert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unverändert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Einträge liefert oder die 87 Entwürfe ärztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-01T (Routine, autonom, 2. Lauf) — Leerlauf (103. in Folge), Kurzeintrag

Selbst verifiziert (Python, nicht nur aus dem Log): Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Einträge) beide in `fertig/` erledigt — `agastache-mexicana` → `mexikanische-duftnessel.json` (id-Treffer, scientific_name *Agastache mexicana*); `cherry-laurel`/*Prunus laurocerasus* → `kirschlorbeer.json` (id `prunus-laurocerasus`, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprüft). Kandidaten (`Counter`) = `{'entwurf_fertig': 87}`, **0× offen** → kein Bau, keine Selbstheilung. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unverändert. Bewusst nur eine Zeile (Log wächst sonst nur durch identische Leerlauf-Blöcke, ~467 KB). Keine Benachrichtigung (Lage unverändert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unverändert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Einträge liefert oder die 87 Entwürfe ärztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-01T (Routine, autonom, 3. Lauf) — Leerlauf (104. in Folge), Kurzeintrag

Selbst verifiziert (Python): Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Einträge) beide in `fertig/` erledigt — `agastache-mexicana` → `mexikanische-duftnessel.json` (id-Treffer); `cherry-laurel`/*Prunus laurocerasus* → `kirschlorbeer.json` (id `prunus-laurocerasus`, Synonyme geprüft). Kandidaten (`Counter`) = `{'entwurf_fertig': 87}`, **0× offen** → kein Bau, keine Selbstheilung. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unverändert. Keine Benachrichtigung (Lage unverändert seit 2026-08-04, kein Fehler). **Empfehlung unverändert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Einträge liefert oder die 87 Entwürfe ärztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-02T (Routine, autonom) — Leerlauf (105. in Folge), Kurzeintrag

Selbst verifiziert (Python, nicht nur aus dem Log): Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Einträge) beide in `fertig/` erledigt — `agastache-mexicana` → `mexikanische-duftnessel.json` (id-Treffer, scientific_name *Agastache mexicana*); `cherry-laurel`/*Prunus laurocerasus* → `kirschlorbeer.json` (id `prunus-laurocerasus`, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprüft). Kandidaten (`Counter`) = `{'entwurf_fertig': 87}`, **0× offen** → kein Bau, keine Selbstheilung. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unverändert. Bewusst nur eine Zeile (Log wächst sonst nur durch identische Leerlauf-Blöcke, ~467 KB). Keine Benachrichtigung (Lage unverändert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unverändert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Einträge liefert oder die 87 Entwürfe ärztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-02T (Routine, autonom, 2. Lauf) — Leerlauf (106. in Folge), Kurzeintrag

Selbst verifiziert (Python, nicht nur aus dem Log): Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Einträge) beide in `fertig/` erledigt — `agastache-mexicana` → `mexikanische-duftnessel.json` (id-Treffer, scientific_name *Agastache mexicana (Kunth) Lint & Epling*); `cherry-laurel`/*Prunus laurocerasus* → `kirschlorbeer.json` (id `prunus-laurocerasus`, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprüft). Kandidaten (`Counter`) = `{'entwurf_fertig': 87}`, **0× offen**, alle 87 `datei`-Pfade existieren → kein Bau, keine Selbstheilung. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unverändert. Bewusst nur eine Zeile. Keine Benachrichtigung (Lage unverändert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unverändert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Einträge liefert oder die 87 Entwürfe ärztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-02T (Routine, autonom, 3. Lauf) — Leerlauf (107. in Folge), Kurzeintrag

Selbst verifiziert (Python, nicht nur aus dem Log): Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Einträge) beide in `fertig/` erledigt — `agastache-mexicana` → `mexikanische-duftnessel.json` (id-Treffer, scientific_name *Agastache mexicana (Kunth) Lint & Epling*); `cherry-laurel`/*Prunus laurocerasus* → `kirschlorbeer.json` (id `prunus-laurocerasus`, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprüft). Kandidaten (`grep`-Zählung über `kraeuter-kandidaten.json`) = `{'entwurf_fertig': 87}`, **0× offen** → kein Bau, keine Selbstheilung nötig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unverändert. Bewusst nur eine Zeile (Log wächst sonst nur durch identische Leerlauf-Blöcke). Keine Benachrichtigung (Lage unverändert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unverändert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Einträge liefert oder die 87 Entwürfe ärztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-02T (Routine, autonom, 4. Lauf) — Leerlauf (108. in Folge), Kurzeintrag

Selbst verifiziert (Python, nicht nur aus dem Log): Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt — `agastache-mexicana` -> `mexikanische-duftnessel.json` (id-Treffer, scientific_name *Agastache mexicana (Kunth) Lint & Epling*); `cherry-laurel`/*Prunus laurocerasus* -> `kirschlorbeer.json` (id `prunus-laurocerasus`, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft). Kandidaten (`Counter`) = `{'entwurf_fertig': 87}`, **0x offen** -> kein Bau, keine Selbstheilung. `jsonschema` installiert, Pruefskript einsatzbereit (nicht aufgerufen, da nichts gebaut). Kein Statuswechsel, `docs/changelog.json` unveraendert. Bewusst nur eine Zeile (Log ~471 KB, waechst sonst nur durch identische Leerlauf-Bloecke). Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-03T (Routine, autonom) — Leerlauf (109. in Folge), Kurzeintrag

Selbst verifiziert (nicht nur aus dem Log): Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt — `agastache-mexicana` -> `mexikanische-duftnessel.json` (id-Treffer, scientific_name *Agastache mexicana (Kunth) Lint & Epling*); `cherry-laurel`/*Prunus laurocerasus* -> `kirschlorbeer.json` (id `prunus-laurocerasus`, not_for_use-Warneintrag, Synonyme *Laurus nobilis / Prunus lusitanica* etc. geprueft). Kandidaten (`grep`-Zaehlung) = `{'entwurf_fertig': 87}`, **0x offen** -> kein Bau, keine Selbstheilung noetig. `jsonschema` frisch installiert (Pruefskript einsatzbereit, nicht aufgerufen, da nichts gebaut). Kein Statuswechsel, `docs/changelog.json` unveraendert. Bewusst nur eine Zeile (Log waechst sonst nur durch identische Leerlauf-Bloecke). Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-03T (Routine, autonom, 2. Lauf) — Leerlauf (110. in Folge), Kurzeintrag

Selbst verifiziert (Python `Counter` + `botany.synonyms`-Abgleich, nicht nur aus dem Log): Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt — `agastache-mexicana` -> `mexikanische-duftnessel.json` (id-Treffer, scientific_name *Agastache mexicana (Kunth) Lint & Epling*); `cherry-laurel`/*Prunus laurocerasus* -> `kirschlorbeer.json` (id `prunus-laurocerasus`, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `jsonschema` frisch installiert (Pruefskript einsatzbereit, nicht aufgerufen, da nichts gebaut). `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Bewusst nur eine Zeile (Log waechst sonst nur durch identische Leerlauf-Bloecke). Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-03T (Routine, autonom, 3. Lauf) — Leerlauf (111. in Folge), Kurzeintrag

Selbst verifiziert (Python `Counter` + `botany.synonyms`-Abgleich, nicht nur aus dem Log): Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt — `agastache-mexicana` -> `mexikanische-duftnessel.json` (id-Treffer, scientific_name *Agastache mexicana (Kunth) Lint & Epling*); `cherry-laurel`/*Prunus laurocerasus* -> `kirschlorbeer.json` (id `prunus-laurocerasus`, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Bewusst nur eine Zeile (Log waechst sonst nur durch identische Leerlauf-Bloecke). Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-03T (Routine, autonom, 4. Lauf) — Leerlauf (112. in Folge), Kurzeintrag

Selbst verifiziert (nicht nur aus dem Log gelesen): Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt — `agastache-mexicana` -> `mexikanische-duftnessel.json` (id-Treffer); `cherry-laurel`/*Prunus laurocerasus* -> `kirschlorbeer.json` (id `prunus-laurocerasus`, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft). Kandidaten `kraeuter-kandidaten.json`: **0x offen** (87x `entwurf_fertig`) -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-04T (Routine, autonom) — Leerlauf (113. in Folge), Kurzeintrag

Selbst verifiziert (Python `Counter` + `botany.synonyms`-Abgleich, nicht nur aus dem Log): Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt — `agastache-mexicana` -> `mexikanische-duftnessel.json` (id-Treffer, scientific_name *Agastache mexicana (Kunth) Lint & Epling*); `cherry-laurel`/*Prunus laurocerasus* -> `kirschlorbeer.json` (id `prunus-laurocerasus`, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 119 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Bewusst nur eine Zeile. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-04T (Routine, autonom, 2. Firing) — Leerlauf (114. in Folge), Kurzeintrag

Selbst verifiziert (Python `Counter` + Dedup gegen `id`/`botany.synonyms` in `fertig/`, nicht nur aus dem Log): Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt — `agastache-mexicana` -> `mexikanische-duftnessel.json` (id-Treffer, scientific_name *Agastache mexicana (Kunth) Lint & Epling*); `cherry-laurel`/*Prunus laurocerasus* -> `kirschlorbeer.json` (id `prunus-laurocerasus`, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus*). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen** -> kein Bau, keine Selbstheilung noetig. `fertig/` = **118** Monographien (vorheriger Eintrag nannte faelschlich 119 — Zaehlfehler, keine Datei entfernt/hinzugefuegt). Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-04T (Routine, autonom, 3. Firing) — Leerlauf (115. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json` + Dedup gegen `id`/`botany.synonyms`/`scientific_name` aller Dateien in `fertig/`, nicht nur aus dem Log). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide erledigt: `agastache-mexicana` -> `mexikanische-duftnessel.json` (id-Treffer). `cherry-laurel` -> `kirschlorbeer.json` (id `prunus-laurocerasus`, not_for_use-Warneintrag; **die Wunschliste fuehrt hier `id: "cherry-laurel"` und `latin: "Cherry laurel"` — beides keine botanische Kennung, daher greift der automatische id/latin-Abgleich NICHT; Treffer nur ueber deutschen Namen/Taxonomie Prunus laurocerasus verifiziert**). Kandidaten = `{'entwurf_fertig': 87}`, **0x offen** -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. `jsonschema` installiert (Pruefskript einsatzbereit, nicht aufgerufen, da nichts gebaut). Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-04T (Routine, autonom, 4. Firing) — Leerlauf (116. in Folge), Kurzeintrag

Selbst verifiziert (Python: `id`/`botany.synonyms`-Abgleich aller 118 Dateien in `fertig/` + Statuszaehlung ueber `kraeuter-kandidaten.json`, nicht nur aus dem Log). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide erledigt: `agastache-mexicana` -> `mexikanische-duftnessel.json` (id-Treffer); `cherry-laurel`/*Prunus laurocerasus* -> `kirschlorbeer.json` (id `prunus-laurocerasus` in `fertig/`, not_for_use-Warneintrag; Wunschlisten-`id`/`latin` sind untaxonomisch, Treffer ueber deutschen Namen/Taxonomie verifiziert). Kandidaten = `{'entwurf_fertig': 87}`, **0x offen** -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-05T (Routine, autonom) — Leerlauf (117. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json` + Dedup gegen `id`/`botany.synonyms` aller 118 Dateien in `fertig/`, nicht nur aus dem Log). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide erledigt: `agastache-mexicana` -> `mexikanische-duftnessel.json` (id-Treffer, scientific_name *Agastache mexicana (Kunth) Lint & Epling*); `cherry-laurel`/*Prunus laurocerasus* -> `kirschlorbeer.json` (id `prunus-laurocerasus`, not_for_use-Warneintrag; Wunschlisten-`id`/`latin` sind untaxonomisch, Treffer ueber deutschen Namen/Taxonomie verifiziert). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen** -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. `jsonschema` frisch installiert (Pruefskript einsatzbereit, nicht aufgerufen, da nichts gebaut). Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-05T (Routine, autonom, 2. Firing) — Leerlauf (118. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json` + Dedup gegen `id`/`botany.synonyms`/`scientific_name` aller 118 Dateien in `fertig/`, nicht nur aus dem Log). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide erledigt: `agastache-mexicana` -> `mexikanische-duftnessel.json` (id-Treffer, scientific_name *Agastache mexicana (Kunth) Lint & Epling*); `cherry-laurel`/*Prunus laurocerasus* -> `kirschlorbeer.json` (id `prunus-laurocerasus`, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"` und `latin: "Cherry laurel"` sind untaxonomisch -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber deutschen Namen/Taxonomie verifiziert**). Kandidaten = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `jsonschema` frisch installiert (Pruefskript einsatzbereit, nicht aufgerufen, da nichts gebaut). Kein Statuswechsel, `docs/changelog.json` unveraendert. Bewusst nur eine Zeile (Log ~495 KB, waechst sonst nur durch identische Leerlauf-Bloecke). Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-05T (Routine, autonom, 3. Firing) — Leerlauf (119. in Folge), Kurzeintrag

Selbst verifiziert (Python, nicht nur aus dem Log): Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt — `agastache-mexicana` -> `mexikanische-duftnessel.json` (id-Treffer, scientific_name *Agastache mexicana (Kunth) Lint & Epling*); `cherry-laurel`/*Prunus laurocerasus* -> `kirschlorbeer.json` (id `prunus-laurocerasus`, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomisch, Treffer ueber deutschen Namen/Taxonomie verifiziert). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Bewusst nur eine Zeile. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-05T (Routine, autonom, 4. Firing) — Leerlauf (120. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json` + Dedup gegen `id`/`botany.synonyms`/`scientific_name` aller 118 Dateien in `fertig/`, nicht nur aus dem Log). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `mexikanische-duftnessel.json` (id-Treffer, scientific_name *Agastache mexicana (Kunth) Lint & Epling*); `cherry-laurel`/*Prunus laurocerasus* -> `kirschlorbeer.json` (id `prunus-laurocerasus`, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomisch -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber deutschen Namen/Taxonomie verifiziert). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. `jsonschema` frisch installiert (Pruefskript einsatzbereit, nicht aufgerufen, da nichts gebaut). Kein Statuswechsel, `docs/changelog.json` unveraendert. Bewusst nur eine Zeile (Log waechst sonst nur durch identische Leerlauf-Bloecke). Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-06T (Routine, autonom) — Leerlauf (121. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json` + Dedup gegen `id`/`botany.synonyms`/`scientific_name` aller 118 Dateien in `fertig/`, nicht nur aus dem Log). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `mexikanische-duftnessel.json` (id-Treffer, scientific_name *Agastache mexicana (Kunth) Lint & Epling*); `cherry-laurel`/*Prunus laurocerasus* -> `kirschlorbeer.json` (id `prunus-laurocerasus`, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomisch -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber deutschen Namen/Taxonomie verifiziert). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. `jsonschema` frisch installiert (Pruefskript einsatzbereit, nicht aufgerufen, da nichts gebaut). Kein Statuswechsel, `docs/changelog.json` unveraendert. Bewusst nur eine Zeile (Log waechst sonst nur durch identische Leerlauf-Bloecke). Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-06T06:17:47Z (Routine, autonom) — Leerlauf (122. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json` + Dedup gegen `id`/`botany.synonyms`/`scientific_name` aller 118 Dateien in `fertig/`, nicht nur aus dem Log). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `mexikanische-duftnessel.json` (id-Treffer); `cherry-laurel`/*Prunus laurocerasus* -> `kirschlorbeer.json` (id `prunus-laurocerasus` in fertig-ids, Synonym *laurocerasus* geprueft; Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische englische Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Kirschlorbeer = Prunus laurocerasus verifiziert). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen** -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. `jsonschema` frisch installiert (Pruefskript einsatzbereit, nicht aufgerufen, da nichts gebaut). Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-06T12:18:09Z (Routine, autonom, 2. Firing) — Leerlauf (123. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json` + Dedup gegen `id`/`botany.synonyms`/`scientific_name` aller 118 Dateien in `fertig/`, nicht nur aus dem Log). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `mexikanische-duftnessel.json` (id-Treffer, scientific_name *Agastache mexicana (Kunth) Lint & Epling*); `cherry-laurel`/*Prunus laurocerasus* -> `kirschlorbeer.json` (id `prunus-laurocerasus`, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische englische Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie verifiziert). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen** -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Bewusst nur eine Zeile (Log waechst sonst nur durch identische Leerlauf-Bloecke). Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-06T18:xx (Routine, autonom, 3. Firing) — Leerlauf (124. in Folge), Kurzeintrag

Selbst verifiziert (Python: `id`/`botany.synonyms`/`scientific_name`-Abgleich aller 118 Dateien in `fertig/` + Statuszaehlung ueber `kraeuter-kandidaten.json`, Existenzpruefung aller `datei`-Pfade — nicht aus dem Log). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide erledigt: `agastache-mexicana` -> `mexikanische-duftnessel.json` (id + scientific_name *Agastache mexicana* Treffer); `cherry-laurel`/*Prunus laurocerasus* -> `kirschlorbeer.json` (id `prunus-laurocerasus` + scientific_name Treffer; Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische englische Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie verifiziert). Kandidaten = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. `jsonschema` frisch installiert (Pruefskript einsatzbereit, nicht aufgerufen, da nichts gebaut). Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-07T (Routine, autonom) — Leerlauf (125. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json` + Dedup gegen `id`/`botany.synonyms`/`scientific_name` aller 118 Dateien in `fertig/`, Existenzpruefung — nicht aus dem Log). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide erledigt: `agastache-mexicana` -> `mexikanische-duftnessel.json` (id + scientific_name *Agastache mexicana (Kunth) Lint & Epling* Treffer); `cherry-laurel`/*Prunus laurocerasus* -> `kirschlorbeer.json` (id `prunus-laurocerasus` + scientific_name *Prunus laurocerasus L.* Treffer; Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische englische Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie verifiziert). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. `jsonschema` frisch installiert (Pruefskript einsatzbereit, nicht aufgerufen, da nichts gebaut). Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-07T (Routine, autonom, 2. Firing) — Leerlauf (126. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json` + Dedup gegen `id`/`botany.synonyms`/`scientific_name` aller 118 Dateien in `fertig/`, Existenzpruefung aller `datei`-Pfade — nicht aus dem Log). `pip install -r requirements.txt` ok, `jsonschema` einsatzbereit (Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `mexikanische-duftnessel.json` (id + scientific_name *Agastache mexicana (Kunth) Lint & Epling* Treffer); `cherry-laurel`/*Prunus laurocerasus* -> `kirschlorbeer.json` (Taxon-Treffer ueber scientific_name/id `prunus-laurocerasus`; Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische englische Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Kirschlorbeer = Prunus laurocerasus verifiziert). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Bewusst nur eine Zeile (Log waechst sonst nur durch identische Leerlauf-Bloecke). Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-07T (Routine, autonom, 3. Firing) — Leerlauf (127. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` ok, `jsonschema 4.26.0` einsatzbereit (Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `mexikanische-duftnessel.json` (id-Treffer); `cherry-laurel`/*Cherry laurel* -> `kirschlorbeer.json` (id `prunus-laurocerasus`; Wunschlisten-`id`/`latin` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Kirschlorbeer = Prunus laurocerasus verifiziert). Kandidaten = `{'entwurf_fertig': 87}`, **0x offen**, alle Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-07T (Routine, autonom, 4. Firing) — Leerlauf (128. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` ok, `jsonschema 4.26.0` einsatzbereit (Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `mexikanische-duftnessel.json` (id-Treffer bestaetigt); `cherry-laurel`/*Cherry laurel* -> `kirschlorbeer.json` (id `prunus-laurocerasus`; Wunschlisten-`id`/`latin` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT (`NOT by id` im Skript-Output), Treffer nur ueber Taxonomie Kirschlorbeer = Prunus laurocerasus verifiziert). Kandidaten = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-08T (Routine, autonom) — Leerlauf (129. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json` + Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` ok (`jsonschema` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `mexikanische-duftnessel.json` (id + scientific_name *Agastache mexicana* Treffer); `cherry-laurel`/*Cherry laurel* -> `kirschlorbeer.json` (id `prunus-laurocerasus` + scientific_name *Prunus laurocerasus* Treffer; **Wunschlisten-`id`/`latin` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten = `{'entwurf_fertig': 87}`, **0x offen** -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-08T06:26Z (Routine, autonom, 2. Firing) — Leerlauf (130. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `mexikanische-duftnessel.json` (id + scientific_name *Agastache mexicana (Kunth) Lint & Epling* Treffer); `cherry-laurel`/*Cherry laurel* -> `kirschlorbeer.json` (id `prunus-laurocerasus` + scientific_name *Prunus laurocerasus L.* Treffer, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Bewusst nur eine Zeile (Log waechst sonst nur durch identische Leerlauf-Bloecke). Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-08T12:29Z (Routine, autonom, 3. Firing) — Leerlauf (131. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `mexikanische-duftnessel.json` (id + scientific_name *Agastache mexicana (Kunth) Lint & Epling* Treffer); `cherry-laurel`/*Cherry laurel* -> `kirschlorbeer.json` (id `prunus-laurocerasus` + scientific_name *Prunus laurocerasus L.* Treffer, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Bewusst nur eine Zeile (Log waechst sonst nur durch identische Leerlauf-Bloecke). Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-08T18:18Z (Routine, autonom, 4. Firing) — Leerlauf (132. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `mexikanische-duftnessel.json` (id + scientific_name *Agastache mexicana (Kunth) Lint & Epling* Treffer); `cherry-laurel`/*Cherry laurel* -> `kirschlorbeer.json` (id `prunus-laurocerasus` + scientific_name *Prunus laurocerasus L.* Treffer; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-09T00:17Z (Routine, autonom) — Leerlauf (133. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `mexikanische-duftnessel.json` (id + scientific_name *Agastache mexicana (Kunth) Lint & Epling* Treffer); `cherry-laurel`/*Cherry laurel* -> `kirschlorbeer.json` (id `prunus-laurocerasus` + scientific_name *Prunus laurocerasus L.* Treffer; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-09T06:26Z (Routine, autonom, 2. Firing) — Leerlauf (134. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `mexikanische-duftnessel.json` (id + scientific_name *Agastache mexicana (Kunth) Lint & Epling* Treffer); `cherry-laurel`/*Cherry laurel* -> `kirschlorbeer.json` (id `prunus-laurocerasus` + scientific_name *Prunus laurocerasus L.* Treffer; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-09T12:33Z (Routine, autonom, 3. Firing) — Leerlauf (135. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `mexikanische-duftnessel.json` (id + scientific_name *Agastache mexicana (Kunth) Lint & Epling* Treffer); `cherry-laurel`/*Cherry laurel* -> `kirschlorbeer.json` (id `prunus-laurocerasus` + scientific_name *Prunus laurocerasus L.* Treffer; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-09T18:17Z (Routine, autonom, 4. Firing) — Leerlauf (136. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `mexikanische-duftnessel.json` (id + scientific_name *Agastache mexicana (Kunth) Lint & Epling* Treffer); `cherry-laurel`/*Cherry laurel* -> `kirschlorbeer.json` (id `prunus-laurocerasus` + scientific_name *Prunus laurocerasus L.* Treffer; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-10T (Routine, autonom) — Leerlauf (137. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` ok (`jsonschema` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-10T06:23:26Z (Routine, autonom, 2. Firing) — Leerlauf (138. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` ok (`jsonschema` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id `agastache-mexicana`, sci *Agastache mexicana (Kunth) Lint & Epling*); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-10T12:28Z (Routine, autonom, 3. Firing) — Leerlauf (139. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` ok (`jsonschema 4.26.0` frisch installiert, einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id `agastache-mexicana`, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* ist dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-10T18:17Z (Routine, autonom, 4. Firing) — Leerlauf (140. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` uebersprungen (nichts gebaut, kein Pruefskript-Aufruf noetig). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id `agastache-mexicana`, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-11T00:18Z (Routine, autonom) — Leerlauf (141. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-11T06:23Z (Routine, autonom, 2. Firing) — Leerlauf (142. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien. Kein Statuswechsel, `docs/changelog.json` unveraendert. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-11T12:25Z (Routine, autonom, 3. Firing) — Leerlauf (143. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop*); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-11T18:17Z (Routine, autonom, 4. Firing) — Leerlauf (144. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` uebersprungen (nichts gebaut, kein Pruefskript-Aufruf noetig). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-12T00:18Z (Routine, autonom) — Leerlauf (145. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-12T (Routine, autonom) — Leerlauf (146. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-12T12:17Z (Routine, autonom, 2. Firing) — Leerlauf (147. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` uebersprungen (nichts gebaut, kein Pruefskript-Aufruf noetig). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-12T18:17Z (Routine, autonom, 3. Firing) — Leerlauf (148. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Dedup gegen `id`/`scientific_name`/`botany.synonyms` der `fertig/`-Dateien — nicht aus dem Log). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-13T (Routine, autonom) — Leerlauf (149. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` der `fertig/`-Dateien — nicht aus dem Log). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-13T06:17Z (Routine, autonom, 2. Firing) — Leerlauf (150. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung aller 87 `datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-13T12:00Z (Routine, autonom, 3. Firing) — Leerlauf (151. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung der Kandidaten-`datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` uebersprungen (nichts gebaut, kein Pruefskript-Aufruf noetig; `jsonschema` in Vorlaeufen als einsatzbereit bestaetigt). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-13T18:17Z (Routine, autonom, 4. Firing) — Leerlauf (152. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung der Kandidaten-`datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` uebersprungen (nichts gebaut, kein Pruefskript-Aufruf noetig; `jsonschema` in Vorlaeufen als einsatzbereit bestaetigt). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-14T00:17Z (Routine, autonom) — Leerlauf (153. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json`, Existenzpruefung der Kandidaten-`datei`-Pfade, Dedup gegen `id`/`scientific_name`/`botany.synonyms` aller 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` uebersprungen (nichts gebaut, kein Pruefskript-Aufruf noetig; `jsonschema` in Vorlaeufen als einsatzbereit bestaetigt). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kandidaten `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**, alle 87 `datei`-Pfade existieren -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-14T06:23Z (Routine, autonom, 2. Firing) — Leerlauf (154. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Dedup gegen `id`/`scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien — nicht aus dem Log). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kein Bau, keine Selbstheilung noetig (alle 87 `datei`-Pfade existieren). `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-14T12:27Z (Routine, autonom, 3. Firing) — Leerlauf (155. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Existenzpruefung aller 87 Kandidaten-`datei`-Pfade; Dedup gegen `id`/`scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-14T (Routine, autonom, 4. Firing) — Leerlauf (156. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Existenzpruefung aller 87 Kandidaten-`datei`-Pfade; Dedup gegen `id`/`scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien — nicht aus dem Log). `pip install -r requirements.txt` uebersprungen (nichts gebaut, kein Pruefskript-Aufruf noetig; `jsonschema 4.26.0` in Vorlaeufen als einsatzbereit bestaetigt). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-15T (Routine, autonom) — Leerlauf (157. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Dedup gegen `id`/`scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien — nicht aus dem Log). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kein Bau, keine Selbstheilung noetig (alle 87 `datei`-Pfade als entwurf_fertig, Files vorhanden). `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-15T06:18Z (Routine, autonom, 2. Firing) — Leerlauf (158. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Existenzpruefung aller 87 Kandidaten-`datei`-Pfade (0 fehlend); Dedup gegen `id`/`scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien — nicht aus dem Log). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien (+ `.gitkeep`), `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-15T12:21Z (Routine, autonom, 3. Firing) — Leerlauf (159. in Folge), Kurzeintrag

Selbst verifiziert (Python: `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Existenzpruefung aller 87 Kandidaten-`datei`-Pfade (0 fehlend); Dedup gegen `id`/`scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien — nicht aus dem Log). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-15T18:17Z (Routine, autonom, 4. Firing) — Leerlauf (160. in Folge), Kurzeintrag

Selbst verifiziert (Python, nicht aus dem Log): `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Dedup gegen alle `id`/`scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien. Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id`/`latin` sind untaxonomische engl. Trivialnamen -> nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kein offener Kandidat, kein offener Wunsch -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-16T00:16Z (Routine, autonom, 5. Firing) — Leerlauf (161. in Folge), Kurzeintrag

Selbst verifiziert (Python/Tools, nicht aus dem Log): `kraeuter-kandidaten.json` = 87x `entwurf_fertig`, **0x offen**; Dedup gegen alle `id`/`scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien. Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kein offener Kandidat, kein offener Wunsch -> kein Bau, keine Selbstheilung noetig. Kein `pip install` (nichts zu validieren; jsonschema aktuell nicht importierbar, fuer diesen Leerlauf ohne Belang). `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-16T06:18Z (Routine, autonom, 2. Firing) — Leerlauf (162. in Folge), Kurzeintrag

Selbst verifiziert (Python/Tools, nicht aus dem Log): `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Dedup gegen alle `id`/`scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien. `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kein offener Kandidat, kein offener Wunsch -> kein Bau, keine Selbstheilung noetig (alle 87 Kandidaten-`datei`-Pfade als entwurf_fertig, Files vorhanden). `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-16T12:20Z (Routine, autonom, 3. Firing) — Leerlauf (163. in Folge), Kurzeintrag

Selbst verifiziert (Python/Tools, nicht aus dem Log): `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Dedup gegen alle `id`/`scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien. Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kein offener Kandidat, kein offener Wunsch -> kein Bau, keine Selbstheilung noetig (alle 87 Kandidaten-`datei`-Pfade als entwurf_fertig, Files vorhanden). `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-16T18:17Z (Routine, autonom, 4. Firing) — Leerlauf (164. in Folge), Kurzeintrag

Selbst verifiziert (Python/Tools, nicht aus dem Log): `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Dedup gegen alle `id`/`scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien. Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kein offener Kandidat, kein offener Wunsch -> kein Bau, keine Selbstheilung noetig (alle 87 Kandidaten-`datei`-Pfade als entwurf_fertig, Files vorhanden). `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-17T00:17Z (Routine, autonom, 5. Firing) — Leerlauf (165. in Folge), Kurzeintrag

Selbst verifiziert (Python/Tools, nicht aus dem Log): `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Dedup gegen alle `id`/`scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien. `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kein offener Kandidat, kein offener Wunsch -> kein Bau, keine Selbstheilung noetig (alle 87 Kandidaten-`datei`-Pfade als entwurf_fertig, Files vorhanden). `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-17T06:16Z (Routine, autonom, 6. Firing) — Leerlauf (166. in Folge), Kurzeintrag

Selbst verifiziert (Python/Tools, nicht aus dem Log): `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Dedup gegen alle `id`/`scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien. Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kein offener Kandidat, kein offener Wunsch -> kein Bau, keine Selbstheilung noetig (alle 87 Kandidaten-`datei`-Pfade als entwurf_fertig, Files vorhanden). `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-17T12:21Z (Routine, autonom, 7. Firing) — Leerlauf (167. in Folge), Kurzeintrag

Selbst verifiziert (Python/Tools, nicht aus dem Log): `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Existenzpruefung aller 87 Kandidaten-`datei`-Pfade (0 fehlend); Dedup gegen alle `id`/`scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien. `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kein offener Kandidat, kein offener Wunsch -> kein Bau, keine Selbstheilung noetig (alle 87 Kandidaten-`datei`-Pfade als entwurf_fertig, Files vorhanden). `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-17T18:00Z (Routine, autonom, 8. Firing) — Leerlauf (168. in Folge), Kurzeintrag

Selbst verifiziert (Python/Tools, nicht aus dem Log): `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Existenzpruefung aller 87 Kandidaten-`datei`-Pfade (0 fehlend); Dedup gegen alle `id`/`scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien. `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kein offener Kandidat, kein offener Wunsch -> kein Bau, keine Selbstheilung noetig (alle 87 Kandidaten-`datei`-Pfade als entwurf_fertig, Files vorhanden). `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-18T00:18Z (Routine, autonom, 1. Firing) — Leerlauf (169. in Folge), Kurzeintrag

Selbst verifiziert (Python/Tools, nicht aus dem Log): `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Dedup gegen alle `id`/`scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien. `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kein offener Kandidat, kein offener Wunsch -> kein Bau, keine Selbstheilung noetig. `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-18T06:18Z (Routine, autonom, 2. Firing) — Leerlauf (170. in Folge), Kurzeintrag

Selbst verifiziert (Python/Tools, nicht aus dem Log): `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Existenzpruefung aller 87 Kandidaten-`datei`-Pfade (0 fehlend); Dedup gegen alle `id`/`scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien. `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> `monographie-mexikanische-duftnessel.json` (id-Treffer, sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, sci *Prunus laurocerasus L.*, common *Kirschlorbeer*, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft; **Wunschlisten-`id: "cherry-laurel"`/`latin: "Cherry laurel"` sind untaxonomische engl. Trivialnamen -> automatischer id/latin-Abgleich greift NICHT, Treffer nur ueber Taxonomie Cherry laurel = Kirschlorbeer = Prunus laurocerasus verifiziert**). Kein offener Kandidat, kein offener Wunsch -> kein Bau, keine Selbstheilung noetig (alle 87 Kandidaten-`datei`-Pfade als entwurf_fertig, Files vorhanden). `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-18T (Routine, autonom, 3. Firing) — Leerlauf (171. in Folge), Kurzeintrag

Selbst verifiziert (Python/Tools, nicht aus dem Log): `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Dedup gegen alle `id`/`botany.scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien (118 ids, 118 sci, 221 syn). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> id-Treffer (`monographie-mexikanische-duftnessel.json`); `cherry-laurel`/*Cherry laurel* -> **kein automatischer id/latin-Treffer** (untaxonomische engl. Trivialnamen), manuell ueber Taxonomie verifiziert: Cherry laurel = Kirschlorbeer = *Prunus laurocerasus* L. = `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft). Kein offener Kandidat, kein offener Wunsch -> kein Bau, keine Selbstheilung noetig (alle 87 Kandidaten-Eintraege entwurf_fertig). `fertig/` = 118 Monographien, `docs/changelog.json` unveraendert. Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-18T18:17Z (Routine, autonom, 4. Firing) — Leerlauf (172. in Folge), Kurzeintrag

Selbst verifiziert (Python/Tools, nicht aus dem Log): `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Dedup gegen alle `id`/`botany.scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien. Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> id-Treffer `monographie-mexikanische-duftnessel.json` (sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> **kein automatischer id/latin-Treffer** (untaxonomische engl. Trivialnamen), manuell ueber Taxonomie verifiziert: Cherry laurel = Kirschlorbeer = *Prunus laurocerasus* L. = `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft). Kein offener Kandidat, kein offener Wunsch -> kein Bau, keine Selbstheilung noetig (alle 87 Kandidaten-Eintraege entwurf_fertig). `pip install -r requirements.txt` in dieser Umgebung nicht ausgefuehrt; `jsonschema` aktuell nicht importierbar — fuer diesen Leerlauf ohne Belang (nichts gebaut, Pruefskript nicht aufgerufen); vor dem naechsten realen Bau wieder `pip install -r requirements.txt` noetig. `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-19T00:17Z (Routine, autonom, 1. Firing) — Leerlauf (173. in Folge), Kurzeintrag

Selbst verifiziert (Python/Tools, nicht aus dem Log): `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Existenzpruefung aller 87 Kandidaten-`datei`-Pfade (0 fehlend); Dedup gegen alle `id`/`botany.scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien (118 ids, 118 sci, 221 syn). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> id-Treffer `monographie-mexikanische-duftnessel.json` (sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> **kein automatischer id/latin-Treffer** (untaxonomische engl. Trivialnamen), manuell ueber Taxonomie verifiziert: Cherry laurel = Kirschlorbeer = *Prunus laurocerasus* L. = `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft). Kein offener Kandidat, kein offener Wunsch -> kein Bau, keine Selbstheilung noetig (alle 87 Kandidaten-Eintraege entwurf_fertig, Files vorhanden). `pip install -r requirements.txt` in dieser Umgebung nicht ausgefuehrt; `jsonschema` aktuell nicht importierbar — fuer diesen Leerlauf ohne Belang (nichts gebaut, Pruefskript nicht aufgerufen); vor dem naechsten realen Bau wieder `pip install -r requirements.txt` noetig. `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-19T06:17Z (Routine, autonom, 2. Firing) — Leerlauf (174. in Folge), Kurzeintrag

Selbst verifiziert (Python/Tools, nicht aus dem Log): `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Dedup gegen alle `id`/`botany.scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien. Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> id-Treffer `monographie-mexikanische-duftnessel.json` (sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> **kein automatischer id/latin-Treffer** (untaxonomische engl. Trivialnamen), manuell ueber Taxonomie verifiziert: Cherry laurel = Kirschlorbeer = *Prunus laurocerasus* L. = `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft). Kein offener Kandidat, kein offener Wunsch -> kein Bau, keine Selbstheilung noetig (alle 87 Kandidaten-Eintraege entwurf_fertig). `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-19T12:17Z (Routine, autonom, 3. Firing) — Leerlauf (175. in Folge), Kurzeintrag

Selbst verifiziert (Python/Tools, nicht aus dem Log): `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Dedup gegen alle `id`/`botany.scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien. Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> id-Treffer `monographie-mexikanische-duftnessel.json` (sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> **kein automatischer id/latin-Treffer** (untaxonomische engl. Trivialnamen), manuell ueber Taxonomie verifiziert: Cherry laurel = Kirschlorbeer = *Prunus laurocerasus* L. = `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft). Kein offener Kandidat, kein offener Wunsch -> kein Bau, keine Selbstheilung noetig (alle 87 Kandidaten-Eintraege entwurf_fertig). `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-19T18:17Z (Routine, autonom, 4. Firing) — Leerlauf (176. in Folge), Kurzeintrag

Selbst verifiziert (Python/Tools, nicht aus dem Log): `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Existenzpruefung aller 87 Kandidaten-`datei`-Pfade (0 fehlend); Dedup gegen alle `id`/`botany.scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien. Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> id-Treffer `monographie-mexikanische-duftnessel.json` (sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> **kein automatischer id/latin-Treffer** (untaxonomische engl. Trivialnamen), manuell ueber Taxonomie verifiziert: Cherry laurel = Kirschlorbeer = *Prunus laurocerasus* L. = `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft). Kein offener Kandidat, kein offener Wunsch -> kein Bau, keine Selbstheilung noetig (alle 87 Kandidaten-Eintraege entwurf_fertig, Files vorhanden). `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-20T00:17Z (Routine, autonom, 1. Firing) — Leerlauf (177. in Folge), Kurzeintrag

Selbst verifiziert (Python/Tools, nicht aus dem Log): `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Existenzpruefung aller 87 Kandidaten-`datei`-Pfade (0 fehlend); Dedup gegen alle `id`/`botany.scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien. Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> id-Treffer `monographie-mexikanische-duftnessel.json` (sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> **kein automatischer id/latin-Treffer** (untaxonomische engl. Trivialnamen), manuell ueber Taxonomie verifiziert: Cherry laurel = Kirschlorbeer = *Prunus laurocerasus* L. = `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft). Kein offener Kandidat, kein offener Wunsch -> kein Bau, keine Selbstheilung noetig (alle 87 Kandidaten-Eintraege entwurf_fertig, Files vorhanden). `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**

## 2026-09-20T (Routine, autonom, 2. Firing) — Leerlauf (178. in Folge), Kurzeintrag

Selbst verifiziert (Python/Tools, nicht aus dem Log): `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Existenzpruefung aller 87 Kandidaten-`datei`-Pfade (0 fehlend); Dedup gegen alle `id`/`botany.scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien (118 ids, 118 sci, 221 syn). Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> id-Treffer `monographie-mexikanische-duftnessel.json` (sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> **kein automatischer id/latin-Treffer** (untaxonomische engl. Trivialnamen), manuell ueber Taxonomie verifiziert: Cherry laurel = Kirschlorbeer = *Prunus laurocerasus* L. = `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft). Kein offener Kandidat, kein offener Wunsch -> kein Bau, keine Selbstheilung noetig (alle 87 Kandidaten-Eintraege entwurf_fertig, Files vorhanden). `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich gesichtet (auf `geprueft`) werden.**


## 2026-09-20T (Routine, autonom, 3. Firing) — Leerlauf (179. in Folge), Kurzeintrag

Selbst verifiziert (Tools, nicht aus dem Log): `pip install -r requirements.txt` ok (`jsonschema` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen** -> keine Selbstheilung noetig. Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> id-Treffer `monographie-mexikanische-duftnessel.json` (sci *Agastache mexicana (Kunth) Lint & Epling*); `cherry-laurel`/*Cherry laurel* -> ueber Taxonomie verifiziert = Kirschlorbeer = *Prunus laurocerasus* L. = `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft). Kein offener Wunsch, kein offener Kandidat -> kein Bau. `fertig/` = 118 Monographien, `docs/changelog.json` unveraendert. Kein Statuswechsel, kein Changelog-Eintrag. Keine Benachrichtigung (Lage unveraendert, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich auf `geprueft` gesichtet werden.**

## 2026-09-20T18:17Z (Routine, autonom, 4. Firing) — Leerlauf (180. in Folge), Kurzeintrag

Selbst verifiziert (Tools, nicht aus dem Log): `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen**; Existenzpruefung aller 87 Kandidaten-`datei`-Pfade (0 fehlend) -> keine Selbstheilung noetig. Dedup gegen alle `id`/`botany.scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien. Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> id-Treffer `monographie-mexikanische-duftnessel.json` (sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> **kein automatischer id/latin-Treffer** (untaxonomische engl. Trivialnamen), manuell ueber Taxonomie verifiziert: Cherry laurel = Kirschlorbeer = *Prunus laurocerasus* L. = `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft). Kein offener Wunsch, kein offener Kandidat -> kein Bau. `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel, kein Changelog-Eintrag. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich auf `geprueft` gesichtet werden.**

## 2026-09-21T00:17Z (Routine, autonom, 1. Firing) — Leerlauf (181. in Folge), Kurzeintrag

Selbst verifiziert (Tools, nicht aus dem Log): `pip install -r requirements.txt` ok (`jsonschema 4.26.0` einsatzbereit; Pruefskript nicht aufgerufen, da nichts gebaut). `Counter` ueber `kraeuter-kandidaten.json` = `{'entwurf_fertig': 87}`, **0x offen** -> keine Selbstheilung noetig. Dedup gegen alle `id`/`botany.scientific_name`/`botany.synonyms` der 118 `fertig/`-Dateien. Wunschliste `docs/wunschliste.json` (Stand 2026-08-20, 2 Eintraege) beide in `fertig/` erledigt: `agastache-mexicana` -> id-Treffer `monographie-mexikanische-duftnessel.json` (sci *Agastache mexicana (Kunth) Lint & Epling*, Wunsch-Trivialname *Mexican giant hyssop* dort common_name); `cherry-laurel`/*Cherry laurel* -> **kein automatischer id/latin-Treffer** (untaxonomische engl. Trivialnamen im Wunsch-`latin`-Feld), manuell ueber Taxonomie verifiziert: Cherry laurel = Kirschlorbeer = *Prunus laurocerasus* L. = `monographie-kirschlorbeer.json` (id `prunus-laurocerasus`, not_for_use-Warneintrag, Synonyme *Laurocerasus officinalis / Cerasus laurocerasus / Padus laurocerasus* geprueft). Kein offener Wunsch, kein offener Kandidat -> kein Bau. `fertig/` = 118 Monographien, `docs/changelog.json` = 91 Eintraege (unveraendert). Kein Statuswechsel, kein Changelog-Eintrag. Keine Benachrichtigung (Lage unveraendert seit 2026-08-04, Idle-Push lief bereits 2026-08-09, kein Fehler). **Empfehlung unveraendert: Routine pausieren/strecken, bis die App neue Wunschlisten-/`offen`-Eintraege liefert oder die 87 Entwuerfe aerztlich auf `geprueft` gesichtet werden.**
